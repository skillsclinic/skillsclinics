        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('users.tutee.session.update', ['user_id' => $user->id, 'tutee_id' => $tutee->id, 'session_id' => $session->id]) }}"
                              method="POST">
                            {{method_field('PUT')}}
                            @csrf
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="inputGroupSelect01" name="mentor_id" >
                                    ...
                                    @foreach($mentors as $mentor)
                                        {{--<option value="{{ $mentor->id }}">{{ $mentor->profile->lastName }}, {{ $mentor->profile->firstName }}</option>--}}
                                        @if($mentor->id === $session->mentor_id)
                                            <option selected value="{{ $mentor->id }}">{{ $mentor->profile->lastName }}
                            ...
                            <div class="form-group">
                                <label>Data</label>
                                <input type="date" class="form-control" name="date" required value="{{ $session->date }}">
                                @if ($errors->has('date'))
                                    <span class="alert-danger" role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="time" class="form-control" readonly name="time_in" required
                                       value="{{date('h:i a', strtotime($session->time_in))}}" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="timeout" class="form-control" readonly name="time_out" required
                                       value="{{date('h:i a', strtotime($session->time_out))}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="areaOfConcern" required>{{ $session->areaOfConcern }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" min="1" max="10" name="pre_test" type="number"
                                       placeholder="1-10" required value="{{ $session->pre_test }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" min="1" max="10" name="post_test" type="number"
                                       placeholder="1-10" required value="{{ $session->post_test }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" min="1" max="5" name="remarks" type="number"
                                       placeholder="1-5" required value="{{ $session->remarks }}"/>
